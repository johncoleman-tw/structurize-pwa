...
wasmImports.jsbody = {
	...
	'_JSSymbol.referenceEquals___JSSymbol_JSSymbol_JSBoolean' : (...args) => (function(sym0,sym1){
		try{
			...
			conversion.handleJSError(e);}}).call(...args),
	'_StructurizrParser.hostReadFileRaw___String_JSString' : (...args) => (function(path){
		try{
			var r = globalThis.structurizrReadFile(String(path)); return (r === undefined || r === null) ? null : String(r);
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
	'_StructurizrParser.installParseDsl___BiFunction_V' : (...args) => (function(fn){
		try{
			globalThis.structurizrParseDsl = fn;
		}catch( e ) {
			conversion.handleJSError(e);}}).call(...args),
